...
sed -i'' -e "s/'CFBundleShortVersionString': '.*'/'CFBundleShortVersionString': '${VERSION}'/g" eyeblink_gui.spec
sed -i'' -e "s/version='3.0.0'/version='${VERSION}'/g" eyeblink_gui.spec
